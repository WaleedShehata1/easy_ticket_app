...
import 'package:easy_ticket_app/screen/payment_method.dart';
                          ...
                          DefaultButtom(
                            Child: Transform.rotate(
                              ...
                              child: Icon(
                                ...
                                color:
                                    switshTicket ? Colors.white : Colors.black,
                                size: 23.w,
                              ),
                            ),
                            Height: 28,
                                ...
                                onTap: () {
                                  return showDialog(
                                      ...
                                      builder: (context) {
                                        return DefaultDialog(
                                            Child: BuyBusTicket(
                                          id: ticket_metro.ticket[index]['id'],
                                          id_ticket: ticket_metro.ticket[index]
                                              ['id'],
                                          priceBus: ticket_metro.ticket[index]
                                              ['ticket_price'],
                                          ticket_number:
