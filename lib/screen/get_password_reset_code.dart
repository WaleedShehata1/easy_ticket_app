                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                            ...
                            value: 1,
                              title: Transform.translate(
                                ...
                                child: Container(
                                    ...
                                    child: const Text('Send the code to the phone number',style: TextStyle(color: Colors.white),)),
                              ),
                            ...
                            value: 2,
                              ...
                              title: Transform.translate(
                                ...
                                child: Container(
                                    ...
                                    child: const Text('Send the code to the e-mail',style: TextStyle(color: Colors.white),)),
                              ),
                              subtitle: Transform.translate(
                                 offset: const Offset(-10, 0),
                                child: Container(
                                    ...
                                    child: const Text('w************9@gmail.com',style: TextStyle(color: Colors.white),)),
                              ),
                            ),
                          ]),
                      ),
                      ...
                      DefaultButtom(
                        Child: const Text('Send',style: TextStyle(color: Colors.black,fontSize: 24,fontWeight: FontWeight.bold),),
                         Height: 35, Width: 150, PaddingHorizontal: 0,radius: 15, PaddingVertical: 0,color: Colors.white,OnTap: () {
